(function(self) {
  ...
  Encoder.prototype.temp_finish = function(mimeType) {
    ...
    temp_dataViews = this.dataViews.slice();
    temp_dataViews.unshift(view);
    var blob = new Blob(temp_dataViews, { type: 'audio/wav' });
    return blob;
  };
